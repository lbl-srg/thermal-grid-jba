...
model Reset "Supervisory supply temperature reset"
  ...
  parameter Modelica.Units.SI.Temperature TWatSupSetMinMax(displayUnit="degC")
    "Minimum for HW or maximum for CHW supply temperature set point";
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u "Enable signal"
    annotation (Placement(transformation(extent={{-140,40},{-100,80}}),
        iconTransformation(extent={{-140,40},{-100,80}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TWatSupPreSet(final unit="K",
      displayUnit="degC") "Water supply temperature set point" annotation (
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput TWatSupSet(final unit="K",
      displayUnit="degC") "Water supply temperature set point after reset"
    annotation (Placement(transformation(extent={{100,-20},{140,20}}),
        iconTransformation(extent={{100,-20},{140,20}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant minMaxSet(k=
        TWatSupSetMinMax)
    "Minimum value of HW set point or maximum value of CHW set point"
    annotation (Placement(transformation(extent={{-60,-30},{-40,-10}})));
  Buildings.Controls.OBC.CDL.Reals.Switch swi "Switch"
    annotation (Placement(transformation(extent={{0,-10},{20,10}})));
  Buildings.Controls.OBC.CDL.Reals.LimitSlewRate ramLim(raisingSlewRate=0.1)
    "Limit the rate of change"
    annotation (Placement(transformation(extent={{50,-10},{70,10}})));
equation
  connect(TWatSupPreSet, swi.u1) annotation (Line(points={{-120,-50},{-80,-50},{
          -80,8},{-2,8}}, color={0,0,127}));
  connect(minMaxSet.y, swi.u3) annotation (Line(points={{-38,-20},{-20,-20},{-20,
          -8},{-2,-8}}, color={0,0,127}));
  connect(u, swi.u2) annotation (Line(points={{-120,60},{-60,60},{-60,0},{-2,0}},
        color={255,0,255}));
  connect(swi.y, ramLim.u)
    annotation (Line(points={{22,0},{48,0}}, color={0,0,127}));
  connect(ramLim.y, TWatSupSet)
...
<p>
Copied from Buildings.DHC.ETS.Combined.Controls.Supervisory.
</p>
</html>"));
end Reset;
