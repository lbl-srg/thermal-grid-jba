...
model SideCold "Control block for cold side"
  ...
  Buildings.DHC.ETS.Combined.Controls.PIDWithEnable conTChiWatSup(
    ...
    final yMin=0,
    final yMax=1,
    final reverseActing=false) "Controller for CHWST"
  ...
  Buildings.Controls.OBC.CDL.Reals.GreaterThreshold greThr(t=0.01)
    "Control signal is non zero (with 1% tolerance)"
    annotation (Placement(transformation(extent={{-40,-130},{-20,-110}})));
  Modelica.Blocks.Discrete.ZeroOrderHold zeroOrderHold(samplePeriod=900)
    annotation (Placement(transformation(extent={{80,-110},{100,-90}})));
  Buildings.Controls.OBC.CDL.Reals.AddParameter addLoc(p=1)
    "Add temperature difference for lockout"
    annotation (Placement(transformation(extent={{-80,-70},{-60,-50}})));
  Buildings.Controls.OBC.CDL.Reals.Greater isAboLoc(h=0.1)
    "Check if temperature is above lockout"
...
equation
  ...
  connect(uCol,greThr.u)
    annotation (Line(points={{-200,0},{-160,0},{-160,-120},{-42,-120}},
                                                                      color={0,0,127}));
  ...
  connect(greThr.y, and2.u2) annotation (Line(points={{-18,-120},{-10,-120},{
          -10,-108},{-2,-108}}, color={255,0,255}));
  connect(isAboLoc.y, and2.u1) annotation (Line(points={{-18,-70},{-10,-70},{
          -10,-100},{-2,-100}}, color={255,0,255}));
  connect(isAboLoc.u1, addLoc.y) annotation (Line(points={{-42,-70},{-50,-70},{
          -50,-60},{-58,-60}}, color={0,0,127}));
  connect(TBot, isAboLoc.u2) annotation (Line(points={{-200,-80},{-140,-80},{
          -140,-78},{-42,-78}}, color={0,0,127}));
  connect(TSet, addLoc.u) annotation (Line(points={{-200,40},{-172,40},{-172,
