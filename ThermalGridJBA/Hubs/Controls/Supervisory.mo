...
model Supervisory "Supervisory controller"
  ...
  Buildings.DHC.ETS.Combined.Controls.SideHot conHot(
    ...
    final controllerType=controllerType) "Hot side controller"
  ...
  Buildings.DHC.ETS.Combined.Controls.SideCold conCol(
    ...
    final TChiWatSupSetMin=TChiWatSupSetMin) "Cold side controller"
  ...
  Buildings.DHC.ETS.Combined.Controls.Reset resTSup(final THeaWatSupSetMin=
        THeaWatSupSetMin) "Supply temperature reset"
    annotation (Placement(transformation(extent={{-70,10},{-50,30}})));
  Reset resTCooSup(final TWatSupSetMinMax=TChiWatSupSetMax)
...
equation
  ...
  connect(TChiWatSupPreSet, resTCooSup.TWatSupPreSet) annotation (Line(points={{
          -140,-40},{-82,-40},{-82,-35},{-72,-35}}, color={0,0,127}));
  ...
  connect(uCooHol.y, resTCooSup.u) annotation (Line(points={{-88,60},{-40,60},{-40,
          -14},{-80,-14},{-80,-24},{-72,-24}}, color={255,0,255}));
  annotation (
    Icon(
      coordinateSystem(
...
Added reset block for CHW supply.
</p>
</html>"));
end Supervisory;
