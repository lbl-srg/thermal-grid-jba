...
pure function getWeatherFileName
  "Function that reads the weather file name from the load profile"
  ...
  output String weaFil
    "String that is read from the file";
protected
  String lin
...
algorithm
  ...
  weaFil := Modelica.Utilities.Strings.scanString(
    string=lin,
    startIndex=nexInd,
