...
equation
  ...
  connect(tanHeaWat.port_bTop, dHFloHeaWat.port_a1)
    annotation (Line(points={{-200,110},{-268,110},{-268,120}},
                                                     color={0,127,255}));
  connect(tanHeaWat.port_aBot, dHFloHeaWat.port_b2)
    annotation (Line(points={{-200,98},{-280,98},{-280,120}},
                                                     color={0,127,255}));
  ...
  connect(tanHeaWat.T[1], conSup.THeaWatTop) annotation (Line(points={{-179,
          101.667},{-172,101.667},{-172,80},{-270,80},{-270,25},{-262,25}},
        color={0,0,127}));
  connect(valHeaDiv.port_b2, tanHeaWat.port_aTop) annotation (Line(points={{
          -176,-10},{-176,76},{-168,76},{-168,110},{-180,110}}, color={0,127,
          255}));
  connect(tanHeaWat.port_bBot,valHeaDiv.port_a2)  annotation (Line(points={{
          -180,98},{-164,98},{-164,-10}}, color={0,127,255}));
  annotation (
    Diagram(
      coordinateSystem(
