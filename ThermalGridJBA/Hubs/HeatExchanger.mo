...
equation
  ...
  connect(port_a2, pum2.port_a) annotation (Line(points={{100,-60},{76,-60},{76,
          -60},{50,-60}}, color={0,127,255}));
  connect(port_b2, senT2WatLvg.port_b) annotation (Line(points={{-100,-60},{-20,
          -60},{-20,-50}}, color={0,127,255}));
  annotation (
