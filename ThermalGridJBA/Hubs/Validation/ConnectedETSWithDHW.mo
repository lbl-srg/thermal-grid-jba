...
model ConnectedETSWithDHW
  "Validation model for the ConnectedETSWithDHW component model"
  ...
  ThermalGridJBA.Hubs.ConnectedETSWithDHW bui(
  ...
  Modelica.Blocks.Continuous.Integrator dHHotWat
...
equation
  ...
  connect(bui.dHHotWat_flow, dHHotWat.u) annotation (Line(points={{44,-22},{44,
          -36},{24,-36},{24,20},{38,20}}, color={0,0,127}));
