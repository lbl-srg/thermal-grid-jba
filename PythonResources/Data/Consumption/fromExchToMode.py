...
#%% Main function
def main(stag, buil_nos, hubname = ''):
    
    """ Sums the hourly consumption of all buildings in `buil_nos`
            to generate the hourly consumption file.
    """
