def write_latex_capacity_table(r,
    ...
    # The line below is needed to avoid UnitParseError: Could not find unit symbol 'gal_US' in the provided symbols
    yt.define_unit("gal_US", 264.172 * yt.Unit("m**3"))
    # The line below is needed to avoid UnitParseError: Could not find unit symbol 'MWh' in the provided symbols
