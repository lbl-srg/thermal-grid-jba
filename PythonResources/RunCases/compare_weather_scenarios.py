...
mat_file['ets']['base'] = os.path.join(CWD, "simulations", "2025-07-10_base-crit", "2025-07-10-base-DetailedPlantFiveHubs.mat")
...
mat_file['ets']['crit'] = os.path.join(CWD, "simulations", "2025-07-10_base-crit", "2025-07-10-crit-DetailedPlantFiveHubs.mat")
mat_file['awhp'] = dict()
...
def write_latex_table_critical():
    ...
    tab += "Required backup electricity for compressor & & & & & \\\\\n"
