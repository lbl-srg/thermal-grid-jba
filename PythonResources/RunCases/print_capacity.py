...
tab += "\\hline\n"
tab += " & System-wide capacity & \\multicolumn{2}{c}{SI unit} & \\multicolumn{2}{c}{IP unit} \\\\\n"
tab += "\\hline\n"
...
# dry cooler
tab += write_row(val = read_parameter('cenPla.gen.dryCoo.m1_flow_nominal'),
                 desc = "Dry cooler - air side",
                 unit_mat = "kg/s",
                 unit_si = "kg/s",
                 unit_ip = "kg/s",
                 display_ip = "FIXME - cfm")

tab += write_row(val = read_parameter('cenPla.gen.dryCoo.m2_flow_nominal'),
                 desc = "Dry cooler - glycol side",
                 unit_mat = "kg/s",
                 unit_si = "kg/s",
                 unit_ip = "kg/s",
                 display_ip = "FIXME - gpm")
