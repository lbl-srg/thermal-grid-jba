within grid.Examples.Combined.BaseClasses;
partial model PartialSeries_chiller "Partial model for series network"
  ...
  // COMPONENTS
  grid.Plants.Reservoir.BoreField borFie(redeclare final package Medium =
        Medium) "Bore field" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-130,-80})));
