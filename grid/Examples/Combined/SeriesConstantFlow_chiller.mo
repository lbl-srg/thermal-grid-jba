within grid.Examples.Combined;
model SeriesConstantFlow_chiller
  "Example of series connection with constant district water mass flow rate"
  extends grid.Examples.Combined.BaseClasses.PartialSeries_chiller(redeclare
      grid.Loads.Combined.BuildingTimeSeriesWithETS_chiller bui[nBui](final
        filNam=filNam), datDes(
